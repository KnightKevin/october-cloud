 ...
 * */
@Slf4j
public class OctoberSentinelInvocationHandler implements InvocationHandler {
    ...
    OctoberSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch, FallbackFactory<?> fallbackFactory) {
    ...
    OctoberSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch) {
        this.target = checkNotNull(target, "target");
        this.dispatch = checkNotNull(dispatch, "dispatch");
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            OctoberSentinelInvocationHandler other = (OctoberSentinelInvocationHandler) obj;
